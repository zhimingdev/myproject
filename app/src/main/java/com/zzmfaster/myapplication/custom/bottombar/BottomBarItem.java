package com.zzmfaster.myapplication.custom.bottombar;
...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        mOpenTouchBg = ta.getBoolean(com.chaychan.library.R.styleable.BottomBarItem_openTouchBg, mOpenTouchBg);
        mTouchDrawable = ta.getDrawable(com.chaychan.library.R.styleable.BottomBarItem_touchDrawable);
